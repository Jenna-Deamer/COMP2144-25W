...
const createScene = async function() {
    ...
    const largeGround = BABYLON.MeshBuilder.CreateGroundFromHeightMap("largeGround", "https://assets.babylonjs.com/environments/villageheightmap.png", {
        width: 150,
        height: 150,
        subdivisions: 20, // how many mesh points on the way up the hill (more = smoother)
        minHeight: 0,
        maxHeight: 20
    });
    ...
    const animCar = new BABYLON.Animation("carAnimation", "position.x", 30, BABYLON.Animation.
